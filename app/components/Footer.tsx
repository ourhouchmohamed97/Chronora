...
const Footer: React.FC = () => {
  ...
  return (
    <footer className={`border-t transition-colors duration-300 ${
      darkMode ? 'bg-[#1a1a22] border-[#2a2a38]' : 'bg-gray-50 border-gray-200'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className={`w-100 mb-4 transition-colors duration-300 ${
        ...
        {/* Bottom Bar */}
        <div className={`border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center transition-colors duration-300 ${
          darkMode ? 'border-[#2a2a38]' : 'border-gray-200'
        }`}>
